(function() {
	...
	var API_WORLDTIME_KEY = "ec31cffdc73621d18f37072320ab5";
	var API_WORLDTIME = "https://api.worldweatheronline.com/free/v2/tz.ashx?format=json&key=" + API_WORLDTIME_KEY + "&q=";

	var API_WEATHER_KEY = "5efe072284c88d3bac8cdb6bef1d53f1";
	var	API_WEATHER_URL = "http://api.openweathermap.org/data/2.5/weather?APPID=" + API_WEATHER_KEY + "&";
	var	IMG_WEATHER = "http://api.openweathermap.org/img/w/" ;
